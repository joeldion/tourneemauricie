...
function tma_participant_cpt() {
    ...
    $args = [
        'labels'        =>  [
            'name'                  =>  esc_html( _nx('Participant', 'Participants', 2, 'Participant name', 'csp') ),
            'singular_name'         =>  esc_html( _nx('Participant', 'Participants', 1, 'Participant name', 'csp') ),
            ...
            'menu_item'             =>  esc_html( _nx('Participant', 'Participants', 2, 'Participant name', 'csp') )
        ],
        'public'        =>  true,
